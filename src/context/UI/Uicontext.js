...
export const UiContext = ({ children }) => {
    ...
    const [activeCategory, setActiveCategory] = useState('tera nasha song')
    const [topCategories, setTopCategories] = useState(['All', 'Tera nasha song', 'Care', 'Programming', 'ReactJs', 'Angular', 'HindiSongs', 'NewNatok', 'Vulona amay song', 'Islamic Songs', 'Figmadesign', 'New Job', 'Movies', 'Funny', 'Science', 'Drama'])
